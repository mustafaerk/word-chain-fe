...
function Button({
  ...
  return (
    <div
      id={id}
      className={`flex items-center justify-center text-white gap-x-2 shadow-3xl ${handleButtonColor()} ${handleBorder()} cursor-pointer rounded-lg m-1 h-12 ${buttonClass} ${
