...
import { clearRoom, roomIdSelector, /* removeUserFromList */ } from "redux/slices/room/roomSlice";
  ...
  return (
    <Main>
      <div className="relative mb-4">
        <img src={CloseSvg} onClick={handleLeaveRoom} alt="leave" className="cursor-pointer w-9 h-9 absolute right-20  -top-10" />
      </div>
