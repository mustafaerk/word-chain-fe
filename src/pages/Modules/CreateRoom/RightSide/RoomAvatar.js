...
const RoomAvatar = ({ emojiInfo, onClick, isSelected, emojiId }) => {
  return (
    <div onClick={() => onClick(emojiId)} className={`flex items-center justify-center flex-col space-y-4  ${isSelected ? "bg-purple" : "bg-primary"} rounded-md w-full h-24 sm:h-36 md:h-52  px-4  `}>
