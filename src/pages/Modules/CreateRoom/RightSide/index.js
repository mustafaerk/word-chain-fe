...
const RightSide = () => {
    ...
    return (
        Object.keys(TextedEmojiList).map((key, idx) => {
            return <RoomAvatar onClick={handleSelectAvatar} key={idx} isSelected={roomInfo.roomAvatarId == key} emojiId={key} emojiInfo={TextedEmojiList[key]} />
        })
    )
}
