...
export const roomApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    eliminateUser: builder.mutation({
      query: ({ data }) => ({
        data,
        method: "POST",
        path: "timeUp",
...
export const { useCreateRoomMutation, useLeaveRoomMutation, useListRoomsQuery, useStartGameMutation, useEliminateUserMutation } = roomApi;
